...
float scaleX = 1.0f, scaleY = 1.0f, scaleZ = 1.0f;  // scale amounts about axes, controlled by mouse
...
//without GLUT_DEPTH it shows the faces in transparency
	glutInitDisplayMode(GLUT_DOUBLE | GLUT_RGBA | GLUT_DEPTH);

	glutInitWindowSize(width, height);
	glutInitWindowPosition(100, 100);
	glutCreateWindow("Lab 00");
